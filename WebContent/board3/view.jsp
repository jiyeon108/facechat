...
<table  align="center" >
<tr><th>댓글</th><td><textarea rows="2" cols="30" name="comment" required="required" ></textarea></td></tr>
<tr><th>댓내</th><td><textarea rows="2" cols="30" name="comment" required="required" ></textarea></td></tr>
</table>
</div>
